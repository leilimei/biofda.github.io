...
class Zakra_Dimensions_Control extends Zakra_Customize_Base_Additional_Control {
	...
	public function to_json() {
		...
		$this->json['sides']   = array(
			'top'    => __( 'Top', 'zakra' ),
			'right'  => __( 'Right', 'zakra' ),
			'bottom' => __( 'Bottom', 'zakra' ),
			'left'   => __( 'Left', 'zakra' ),
		);
	...
	protected function content_template() {
		...
		<div class="zakra-dimension-wrapper">
			<input type="hidden" value='{{{ "object" === typeof data.value ? JSON.stringify( data.value ) : data.value  }}}' id="zakra_dimensions_{{{ data.id }}}" name="zakra_dimensions_{{{ data.id }}}">
			<# if ( data.label ) { #>
			<div class="dimension-label-unit-wrapper">
				...
				<div class="unit-wrapper">
					<div class="input-wrapper">
						...
						<div class="zakra-dimensions-reset">
