	...
	protected function content_template() {
		...
		<div class="customize-control-content">
			...
			<div class="background-color">
				<span class="customize-control-label"><?php esc_html_e( 'Background Color', 'zakra' ); ?></span>
			...
			<div class="background-image">
				<span class="customize-control-label"><?php esc_html_e( 'Background Image', 'zakra' ); ?></span>
			...
			<div class="background-repeat">
				<span class="customize-control-label"><?php esc_html_e( 'Background Repeat', 'zakra' ); ?></span>
			...
			<div class="background-position">
				<span class="customize-control-label"><?php esc_html_e( 'Background Position', 'zakra' ); ?></span>
				<select data-name="{{ data.name }}" {{{ data.inputAttrs }}}>
			...
			<div class="background-size">
				<span class="customize-control-label"><?php esc_html_e( 'Background Size', 'zakra' ); ?></span>
				<select data-name="{{ data.name }}" {{{ data.inputAttrs }}}>
					<option value="cover"
			...
			<div class="background-attachment">
				<span class="customize-control-label"><?php esc_html_e( 'Background Attachment', 'zakra' ); ?></span>
				<select data-name="{{ data.name }}" {{{ data.inputAttrs }}}>
					<option value="scroll"
