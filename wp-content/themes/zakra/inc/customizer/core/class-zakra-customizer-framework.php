...
require dirname( __FILE__ ) . '/class-zakra-customize-base-option.php';
...
class Zakra_Customizer_FrameWork {
	...
	public function customize_custom_controls_includes( $wp_customize ) {
		...
		require dirname( __FILE__ ) . '/custom-controls/support/class-zakra-support-control.php';
		...
		require dirname( __FILE__ ) . '/custom-controls/subtitle/class-zakra-subtitle-control.php';
		...
		require dirname( __FILE__ ) . '/custom-controls/date/class-zakra-date-control.php';
	...
	public function register_panels_sections_controls( $wp_customize ) {
		...
		Zakra_Customize_Base_Control::add_control(
			'zakra-subtitle',
			array(
				'callback' => 'Zakra_Subtitle_Control',
			)
		);
		...
		Zakra_Customize_Base_Control::add_control(
			'zakra-guide',
			array(
				'callback' => 'Zakra_Support_Control',
			)
		);
	...
	public function register_sub_control_setting( $config, $wp_customize ) {
		...
		$new_control_type = Zakra_Customize_Base_Control::get_control_instance( $config[ 'control' ] );
