...
class Zakra_Typography_Control extends Zakra_Customize_Base_Additional_Control {
	...
	public function to_json() {
		...
		$input_attrs = zakra_get_typography_input_attrs( $this->value() );
	...
	protected function content_template() {
		...
		<div class="customize-control-content">
			...
			<div class="font-family customize-group">
				<span class="customize-control-label"><?php esc_html_e( 'Family', 'zakra' ); ?></span>
			...
			<div class="font-weight customize-group">
				<span class="customize-control-label"><?php esc_html_e( 'Weight', 'zakra' ); ?></span>
				<div class="zakra-field-content">
			...
			<div class="subsets customize-group">
				<span class="customize-control-label"><?php esc_html_e( 'Subset(s)', 'zakra' ); ?></span>
				<div class="zakra-field-content">
			...
			<div class="font-size customize-group">
				<div class="desktop control-wrap active">
					...
					<span class="customizer-label-switcher-wrapper">
						<span class="customize-control-label"><?php esc_html_e( 'Size', 'zakra' ); ?></span>
					  ...
					  <div class="unit-wrapper">
						  <div class="input-wrapper">
							  ...
							  <div class="zakra-font-size-reset">
					...
					<div class="control slider-wrapper">
						<span class="zakra-warning zakra-font-size-desktop-warning"
						      id="zakra-font-size-desktop-warning"></span>
						<div class="range">
							<input
								type="range"
						...
						<div class="size zakra-range-value">
							<div class="input-wrapper">
								<input type="number" id="zakra-font-size-desktop-{{{ data.id || data.name }}}"
								       data-device="desktop"
								       min="{{{ data.input_attrs.attributes['font-size']['desktop']['min'] }}}"
								       max="{{{ data.input_attrs.attributes['font-size']['desktop']['max'] }}}"
								       step="{{{ data.input_attrs.attributes['font-size']['desktop']['step'] }}}"
				...
				<div class="tablet control-wrap">
					...
					<div class="control slider-wrapper">
						<span class="zakra-warning zakra-font-size-tablet-warning"
						      id="zakra-font-size-tablet-warning"></span>
						<div class="range">
							<input
								type="range"
								class="zakra-progress"
						...
						<div class="size zakra-range-value">
							<div class="input-wrapper">
								<input type="number" id="zakra-font-size-tablet-{{{ data.id || data.name }}}"
								       data-device="tablet"
								       min="{{{ data.input_attrs.attributes['font-size']['tablet']['min'] }}}"
								       max="{{{ data.input_attrs.attributes['font-size']['tablet']['max'] }}}"
								       step="{{{ data.input_attrs.attributes['font-size']['tablet']['step'] }}}"
				...
				<div class="mobile control-wrap">
					...
					<div class="control slider-wrapper">
						<span class="zakra-warning zakra-font-size-mobile-warning"
						      id="zakra-font-size-mobile-warning"></span>
						<div class="range">
							<input
								type="range"
								class="zakra-progress"
						...
						<div class="size zakra-range-value">
							<div class="input-wrapper">
								<input type="number" id="zakra-font-size-mobile-{{{ data.id || data.name }}}"
								       data-device="mobile"
								       min="{{{ data.input_attrs.attributes['font-size']['mobile']['min'] }}}"
								       max="{{{ data.input_attrs.attributes['font-size']['mobile']['max'] }}}"
								       step="{{{ data.input_attrs.attributes['font-size']['mobile']['step'] }}}"
			...
			<div class="line-height customize-group">
				<div class="desktop control-wrap active">
					<span class="customize-label-wrapper">
					<span class="customizer-label-switcher-wrapper">
						<span class="customize-control-label"><?php esc_html_e( 'Line Height', 'zakra' ); ?></span>
						<ul class="responsive-switchers">
							<li class="desktop active">
								<button type="button" class="preview-desktop" data-device="desktop">
									<i class="dashicons dashicons-desktop"></i>
					  ...
					  <div class="unit-wrapper">
						  <div class="input-wrapper">
							  ...
							  <div class="zakra-line-height-reset">
									<span class="dashicons dashicons-image-rotate"
									      title="<?php esc_attr_e( 'Back to default', 'zakra' ); ?>">
									</span>
								</div>
					...
					<div class="control slider-wrapper">
						<span class="zakra-warning zakra-line-height-desktop-warning"
						      id="zakra-line-height-desktop-warning"></span>
						<div class="range">
							<input
								type="range"
								class="zakra-progress"
						...
						<div class="size zakra-range-value">
							<div class="input-wrapper">
								<input type="number" id="zakra-line-height-desktop-{{{ data.id || data.name }}}"
								       data-device="desktop"
								       min="{{{ data.input_attrs.attributes['line-height']['desktop']['min'] }}}"
								       max="{{{ data.input_attrs.attributes['line-height']['desktop']['max'] }}}"
								       step="{{{ data.input_attrs.attributes['line-height']['desktop']['step'] }}}"
				...
				<div class="tablet control-wrap">
					...
					<div class="control slider-wrapper">
						<span class="zakra-warning zakra-line-height-tablet-warning"
						      id="zakra-line-height-tablet-warning"></span>
						<div class="range">
							<input
								type="range"
								class="zakra-progress"
						...
						<div class="size zakra-range-value">
							<div class="input-wrapper">
								<input type="number" id="zakra-line-height-tablet-{{{ data.id || data.name }}}"
								       data-device="tablet"
								       min="{{{ data.input_attrs.attributes['line-height']['tablet']['min'] }}}"
								       max="{{{ data.input_attrs.attributes['line-height']['tablet']['max'] }}}"
								       step="{{{ data.input_attrs.attributes['line-height']['tablet']['step'] }}}"
				...
				<div class="mobile control-wrap">
					...
					<div class="control slider-wrapper">
						<span class="zakra-warning zakra-line-height-mobile-warning"
						      id="zakra-line-height-mobile-warning"></span>
						<div class="range">
							<input
								type="range"
								class="zakra-progress"
						...
						<div class="size zakra-range-value">
							<div class="input-wrapper">
								<input type="number" id="zakra-line-height-mobile-{{{ data.id || data.name }}}"
								       data-device="mobile"
								       min="{{{ data.input_attrs.attributes['line-height']['mobile']['min'] }}}"
								       max="{{{ data.input_attrs.attributes['line-height']['mobile']['max'] }}}"
								       step="{{{ data.input_attrs.attributes['line-height']['mobile']['step'] }}}"
			...
			<div class="letter-spacing customize-group">
				<div class="desktop control-wrap active">
					...
					<span class="customizer-label-switcher-wrapper">
						<span
							class="customize-control-label"><?php esc_html_e( 'Letter Spacing', 'zakra' ); ?></span>
						<ul class="responsive-switchers">
							<li class="desktop active">
								<button type="button" class="preview-desktop" data-device="desktop">
									<i class="dashicons dashicons-desktop"></i>
					  ...
					  <div class="unit-wrapper">
						  <div class="input-wrapper">
							  ...
							  <div class="zakra-letter-spacing-reset">
									<span class="dashicons dashicons-image-rotate"
									      title="<?php esc_attr_e( 'Back to default', 'zakra' ); ?>">
									</span>
								</div>
					...
					<div class="control slider-wrapper">
						<span class="zakra-warning zakra-letter-spacing-desktop-warning"
						      id="zakra-letter-spacing-desktop-warning"></span>
						<div class="range">
							<input
								type="range"
								class="zakra-progress"
						...
						<div class="size zakra-range-value">
							<div class="input-wrapper">
								<input type="number" id="zakra-letter-spacing-desktop-{{{ data.id || data.name }}}"
								       data-device="desktop"
								       min="{{{ data.input_attrs.attributes['letter-spacing']['desktop']['min'] }}}"
								       max="{{{ data.input_attrs.attributes['letter-spacing']['desktop']['max'] }}}"
								       step="{{{ data.input_attrs.attributes['letter-spacing']['desktop']['step'] }}}"
				...
				<div class="tablet control-wrap">
					...
					<div class="control slider-wrapper">
						<span class="zakra-warning zakra-letter-spacing-tablet-warning"
						      id="zakra-letter-spacing-tablet-warning"></span>
						<div class="range">
							<input
								type="range"
								class="zakra-progress"
						...
						<div class="size zakra-range-value">
							<div class="input-wrapper">
								<input type="number" id="zakra-letter-spacing-tablet-{{{ data.id || data.name }}}"
								       data-device="tablet"
								       min="{{{ data.input_attrs.attributes['letter-spacing']['tablet']['min'] }}}"
								       max="{{{ data.input_attrs.attributes['letter-spacing']['tablet']['max'] }}}"
								       step="{{{ data.input_attrs.attributes['letter-spacing']['tablet']['step'] }}}"
				...
				<div class="mobile control-wrap">
					...
					<div class="control slider-wrapper">
						<span class="zakra-warning zakra-letter-spacing-mobile-warning"
						      id="zakra-letter-spacing-mobile-warning"></span>
						<div class="range">
							<input
								type="range"
						...
						<div class="size zakra-range-value">
							<div class="input-wrapper">
								<input type="number" id="zakra-letter-spacing-mobile-{{{ data.id || data.name }}}"
								       data-device="mobile"
								       min="{{{ data.input_attrs.attributes['letter-spacing']['mobile']['min'] }}}"
								       max="{{{ data.input_attrs.attributes['letter-spacing']['mobile']['max'] }}}"
								       step="{{{ data.input_attrs.attributes['letter-spacing']['mobile']['step'] }}}"
			...
			<div class="font-style customize-group">
				<span class="customize-control-label"><?php esc_html_e( 'Style', 'zakra' ); ?></span>
				<div class="zakra-field-content">
			...
			<div class="text-transform customize-group">
				<span class="customize-control-label"><?php esc_html_e( 'Transform', 'zakra' ); ?></span>
				<div class="zakra-field-content">
			...
			<div class="text-decoration customize-group">
				<span class="customize-control-label"><?php esc_html_e( 'Decoration', 'zakra' ); ?></span>
				<div class="zakra-field-content">
